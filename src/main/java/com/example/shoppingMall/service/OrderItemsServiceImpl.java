...
//        return orderRepository.getItemById(itemId)
//                .map(orderItemsMapper::toOrderItemsResponse)
...
//        OrderItems saved = orderRepository.createItem(orderItem);
...
//        orderRepository.getItemById(itemId)
//                .orElseThrow(() -> new AppException(ErrorCode.ORDER_ITEM_NOT_FOUND));
//        OrderItems patch = orderItemsMapper.toOrderItems(request);
//
//        orderRepository.updateItem(itemId, patch);
//
//        OrderItems updated = orderRepository.getItemById(itemId)
//                .orElseThrow(() -> new AppException(ErrorCode.ORDER_ITEM_NOT_FOUND));
//
...
//        if (!orderRepository.getItemById(itemId).isPresent()) {
