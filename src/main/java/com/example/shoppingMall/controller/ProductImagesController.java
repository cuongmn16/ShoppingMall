...
public class ProductImagesController {
    ...
    public ApiResponse<List<ProductImagesResponse>> getAllProductImages(@PathVariable UUID productId) {
    ...
    public ApiResponse<ProductImagesResponse> getProductImageById(@PathVariable UUID productId, UUID imageId) {
    ...
    public ApiResponse<ProductImagesResponse> deleteProductImageById(@PathVariable UUID productId, UUID imageId) {
        ApiResponse<ProductImagesResponse> apiResponse = new ApiResponse<>();
    ...
    public ApiResponse<ProductImagesResponse> addProductImage(@PathVariable UUID productId, ProductImagesRequest productImagesRequest) {
        ApiResponse<ProductImagesResponse> apiResponse = new ApiResponse<>();
    ...
    public ApiResponse<ProductImagesResponse> updateProductImage(@PathVariable UUID productId, UUID imageId, ProductImagesRequest productImagesRequest) {
        ApiResponse<ProductImagesResponse> apiResponse = new ApiResponse<>();
